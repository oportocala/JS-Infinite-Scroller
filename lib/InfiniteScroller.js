(function () {
    ...
    var self = {
        ...
        setPosition: function (position) {
            var x = (position - this.options.colWidth + this.swapOffset);
            this.inner.style['-webkit-transform'] = 'translate(' + x + 'px, 0px)';
            this.callbacks.updatePosition(x);
        },
        ...
        callbacks: {
            ...
            updatePosition: function (x) {
                return self.callbacks._('updatePosition', x);
            },
        ...
        destroy: function () {
            ...
            this.detachEvents();
            this.inner.style['-webkit-transform'] = '';
            this.container.innerHTML = this.itemTpl.outerHTML;
	      }
    };
